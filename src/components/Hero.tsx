    ...
    <section className="min-h-screen bg-[#121212] flex items-center justify-center relative overflow-hidden pt-24 pb-16 sm:pt-28 sm:pb-20 lg:pt-32 lg:pb-24">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-20 relative w-full">
        <div className="max-w-7xl mx-auto w-full">
          {/* Responsive Layout */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-center lg:text-left min-h-[calc(100vh-16rem)]">
            ...
            <div className="flex justify-center lg:justify-end order-1 lg:order-2 w-full">
              <ScrollReveal direction="down" duration={800} delay={200}>
                <div className="relative">
                  <div className="w-64 h-64 sm:w-72 sm:h-72 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-[#3DDC84] shadow-2xl">
                    <img 
            ...
            <div className="order-2 lg:order-1 w-full">
              <ScrollReveal direction="up" duration={800} delay={400}>
                <div className="space-y-6 py-8 lg:py-16 z-10">
                  <div className="space-y-4">
                    <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-white leading-tight">
                      Shriram Mange
                      <span className="block text-[#3DDC84] text-xl sm:text-2xl lg:text-4xl mt-2">
                        Android Developer
                      </span>
                    </h1>
                  ...
                  <div className="grid grid-cols-2 gap-8 sm:gap-12 pt-8 mt-8 border-t border-gray-700 max-w-md mx-auto lg:mx-0">
                    <div className="text-center lg:text-left">
                      <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#3DDC84] mb-1">15+</div>
                      <div className="text-gray-400 text-xs sm:text-sm">Projects</div>
                    </div>
                    <div className="text-center lg:text-left">
                      <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#3DDC84] mb-1">2+</div>
