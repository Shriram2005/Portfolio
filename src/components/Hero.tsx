    ...
    <section className="min-h-screen bg-[#121212] flex items-center justify-center relative overflow-hidden pt-24 pb-16 sm:pt-28 sm:pb-20 lg:pt-32 lg:pb-24">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-20 relative">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[calc(100vh-12rem)] sm:min-h-[calc(100vh-14rem)] lg:min-h-[calc(100vh-16rem)]">
            
            {/* Content - Mobile First */}
            <ScrollReveal direction="left" duration={800} delay={200}>
              <div className="order-1 text-center lg:text-left space-y-6 py-8 sm:py-12 lg:py-16">
            ...
            <ScrollReveal direction="right" duration={800} delay={400}>
              <div className="order-2 flex justify-center lg:justify-end py-4 lg:py-16">
